...
int main()
{
    ...
    cout << "Introduceti distanta (km) dintre cele doua orase. d = ";
    cin >> d;
    cout << "Doua automobile pornesc in acelasi timp din cele doua orase." << endl;
    cout << "Introduceti viteza (km/h) cu care vreti sa se deplaseze primul automobil. v1 = ";
    cin >> v1;
    cout << "Introduceti viteza (km/h) cu care vreti sa se deplaseze al doilea automobil. v2 = ";
    cin >> v2;
